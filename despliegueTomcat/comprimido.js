...
class Poses extends react_1.default.Component {
    ...
    constructor(props) {
        super(props);
        this.lienzoOcultoR = react_1.default.createRef();
        this.imagenR = react_1.default.createRef();
        this.state = {
            anchoImaPoses: -1,
            alturaImaPoses: -1
        };
    ...
    componentDidMount() {
        ...
        let lienzoOculto = this.lienzoOcultoR.current;
        if (lienzoOculto != null)
            this.contextoOculto = lienzoOculto.getContext("2d");
        else
            this.contextoOculto = null;
        let imagenPoses;
        if (this.imagenR.current != null)
            imagenPoses = this.imagenR.current;
        else
            imagenPoses = null;
...
class Sprite extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.estilo = {};
        this.mover = true;
        this.lienzoR = react_1.default.createRef();
    ...
    render() {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("canvas", { ref: this.lienzoR, width: 640, height: 425, style: this.estilo })));
    }
}
Sprite.defaultProps = {
    frame: {
...
class SpriteControlado extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.estilo = {};
